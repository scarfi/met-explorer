export const MetLogo = ({
  ...
  <path className="st0" d="M82.8,69.2v-1.6c-5.1,0-9.4-1.9-9.4-10.4V35.4h26.1v22.1c0,8.7-4.7,10-9.4,10v1.7h54.3l3-21.9h-1.2
    ...
    fill={color}
  />
  <path className="st0" d="M12.3,81.4H0.1V83c4.9,0,11.1,2.7,11.1,10.4v45.1c0,7.7-6.1,10.4-11.2,10.4v1.6h25v-1.6
